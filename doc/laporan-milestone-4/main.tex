...
\usepackage{float}
\usepackage{tikz}
\usetikzlibrary{automata,positioning,arrows.meta,shapes.geometric,decorations.pathreplacing}
% ---------- Paket lain ----------
...
% Fix overfull hboxes caused by long unbreakable identifiers in text
\sloppy
...
\begin{titlepage}
    ...
    \vspace{0.2cm}
    {\LARGE \textbf{Milestone 4}\par}
    \vspace{0.8cm}
    {\large IF2224 Teori Bahasa Formal dan Otomata\par}
    \vspace{0.2cm}
    {\large Intermediate Code and Interpreter\par}
    \vspace{0.2cm}
